    ...
    private async saveSyncSettings(isAutoSave: boolean = false): Promise<void> {
        try {
            ...
            const globalSettings = {
                sync_contacts_global_enabled: (document.getElementById('sync_contacts_global_enabled') as HTMLInputElement)?.checked || false,
                sync_contacts_global_class: (document.getElementById('sync_contacts_global_class') as HTMLInputElement)?.value || 'Personne',
                sync_contacts_global_mapping: (document.getElementById('sync_contacts_global_mapping') as HTMLTextAreaElement)?.value || '{}',
                sync_contacts_global_filter: (document.getElementById('sync_contacts_global_filter') as HTMLTextAreaElement)?.value || '{}',
                
                sync_calendar_global_enabled: (document.getElementById('sync_calendar_global_enabled') as HTMLInputElement)?.checked || false,
                sync_calendar_global_class: (document.getElementById('sync_calendar_global_class') as HTMLInputElement)?.value || 'Action',
                sync_calendar_global_mapping: (document.getElementById('sync_calendar_global_mapping') as HTMLTextAreaElement)?.value || '{}',
                sync_calendar_array_properties: (document.getElementById('crm-sync-calendar-array-properties') as HTMLTextAreaElement)?.value || '{}',
